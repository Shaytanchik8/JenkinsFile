pipeline{
    ...
    stage('deploy to ec2_server used ansible'){
            steps {
                ansiblePlaybook inventory: '/home/jenkins/ansible/hosts.txt', playbook: '/home/jenkins/ansible/playbook.yml', vaultTmpPath: '', extraVars: [BUILD_NUMBER: env.BUILD_NUMBER]
            }
        }
    }
}
